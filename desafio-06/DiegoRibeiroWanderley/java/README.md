...
4. Para cada palavra do dicionário é verificado se ela cabe no estoque da palavra, se sim adiciona ela em uma lista, somente se ela não já estiver na lista
