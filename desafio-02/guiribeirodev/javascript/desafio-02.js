// Função "verificaPrimo()"" irá verificar se o número é primo, a verificação é feita com base na premissa que todo número primo irá ter apenas dois divisores, o número 1 e ele próprio, então caso o número de divisores sejam 2 será primo.
...
function verificaPrimo(numeroInicio) {
  ...
  for (let count = 1; count <= numeroInicio; count++) {
    if (numeroInicio % count == 0) divisor++
  }
