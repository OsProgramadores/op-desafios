...
def test_is_palindromo():
    ...
    assert numeros_palindromos.is_palindromo(121) is True
    assert numeros_palindromos.is_palindromo(123) is False
    assert numeros_palindromos.is_palindromo(1) is True
    assert numeros_palindromos.is_palindromo(22) is True
    assert numeros_palindromos.is_palindromo(10) is False
