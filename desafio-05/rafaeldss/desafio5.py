...
areas = {area['codigo'] : [area['nome'], 9999999, 0, 0, 0] for area in 
dados['areas']}
    
for funcionario in dados['funcionarios']:
    salario,nome, sobrenome, codigo_area = funcionario['salario'], 
funcionario['nome'], funcionario['sobrenome'], funcionario['area']
