...
class Desafio {
    ...
    private static final void exibirEstatisticaIndividual(CustomWriter cw, Double salario, Collection<String> nomes,
        String tipo, String prefixo, String area) throws IOException {
    ...
    private static final void exibirEstatistica(CustomWriter cw, EstatisticasSalariais es, String prefixo, String area)
        throws IOException {

        exibirEstatisticaIndividual(cw, es.getMaiorSalario(), es.getFuncionariosMaiorSalario(), "max", prefixo, area);
        exibirEstatisticaIndividual(cw, es.getMenorSalario(), es.getFuncionariosMenorSalario(), "min", prefixo, area);
    ...
    private void exibirResultado() {
        ...
        try (CustomWriter cw = new CustomWriter()) {
            ...
            // Questão 3
            final List<Entry<String, Integer>> sorted = quantidadeFuncionariosPorArea.entrySet().stream()
            ...
            for (final Entry<String, EstatisticasSalariais> e : estatisticasPorSobrenome.entrySet()) {
                ...
                if (estatisticas.getTotalFuncionarios() > 1) {
                    ...
                    exibirEstatisticaIndividual(cw, estatisticas.getMaiorSalario(),
                        estatisticas.getFuncionariosMaiorSalario(), "max", "last_name", e.getKey());
